...
Conexio Stratus: nRF9160 Cloud client
#####################
...
.. note::
   ...
   .. code-block:: console
      CONFIG_NRF_CLOUD_CLIENT_ID_PREFIX="str-"

.. _nRF documentation:
   https://infocenter.nordicsemi.com/index.jsp?topic=%2Fug_nrf91_dk_gsg%2FUG%2Fnrf91_DK_gsg%2Fupdating_certificates.html
...
#. Open a terminal emulator and observe that the sample has started.
   ...
   .. code-block:: console
      ...
      I: Conexio nRF Cloud client has started
