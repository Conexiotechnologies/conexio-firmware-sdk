...
static int i2c_init(void) {
    ...
    // For Stratus Pro its i2c2 and for Stratus Gen 1 its i2c1
    i2c_device = DEVICE_DT_GET(DT_NODELABEL(i2c2));
...
int main(void) 
{
    LOG_INF("Usefulsensors person sensor sample started on %s\n", CONFIG_BOARD); 
