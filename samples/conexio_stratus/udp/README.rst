...
Flash the compiled firmware using `newtmgr`
   ...
   newtmgr -c serial image upload build/udp/zephyr/zephyr.signed.bin
...
1. Press the reset button on the the Conexio Stratus to reboot the kit and start the UDP sample.
